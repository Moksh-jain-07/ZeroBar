...
public class MeshSimulatorService {
    ...
    private void seedDefaultDevices() {
        devices.put("phone-mumbai",   new VirtualDevice("phone-mumbai",   false));
        devices.put("phone-delhi",    new VirtualDevice("phone-delhi",    false));
        devices.put("phone-pune",     new VirtualDevice("phone-pune",     false));
        devices.put("phone-kolkata",  new VirtualDevice("phone-kolkata",  false));
        devices.put("phone-bridge-hyderabad", new VirtualDevice("phone-bridge-hyderabad", true));
    }
